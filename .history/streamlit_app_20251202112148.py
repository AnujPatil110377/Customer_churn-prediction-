...
st.write(
    ...
    **This Streamlit App  utilizes a Machine Learning model(XGBoost) API in order to detect whether the customers from a Telco company will churns or not the company.**
    ...
    The notebook, model, documentation (FastAPI script, Streamlit script) and other analysis are available on [GitHub](https://github.com/AnujPatil110377/Customer_churn-prediction-)
